...
**TL;DR**
  ...
  * **Every Bot on your account shares one cloud computer** , which means shared browser cookies, files, and command-line credentials. xAI's own docs say plainly: _"Do not use separate Bots as a security boundary."_ This is the release's biggest open question.
