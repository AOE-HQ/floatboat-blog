...
问「每天早上监控这个竞品的网站、总结新内容、发到我的 Slack」——从答案开始。这里有循环，有外部系统，有依赖前一步的步骤。这是 Agent 的任务——而走到这一步后，下一个问题变成：这些步骤稳不稳定、能不能预先编排进工作流构建器，还是交给[一个替你带着上下文的 AI 工作区](/zh/blog/workflow-builder-vs-ai-workspace)更省心。
