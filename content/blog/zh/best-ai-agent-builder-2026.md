...
### 免费的 AI Agent 构建工具通常自带实用的集成吗？

开源平台——n8n Community Edition、Flowise、Dify——免费自托管且包含大多数集成。代价在基础设施：你需要一台服务器、熟悉 Docker、自己负责维护。这些都能接受的话，零授权费就能拿到能扛生产的工具。云平台的免费档（Zapier Free、Make Free）适合做实验，不适合跑量跑真实工作流。

### 构建工具撞到上限会发生什么？

对无代码平台，上限通常表现为「这个工作流需要的逻辑，构建工具表达不出来」。逃生通道要么是接 webhook 到外部服务，要么迁移到能力更强的平台——项目中途做哪一个都不轻松。对低代码平台，天花板往往是规模化后的性能或复杂的多 Agent 编排。开发者框架几乎没上限，但一切都得你自己管。提前知道自己会撞到哪面墙，正是「选择比你今天需要的稍多一点的平台」的主要理由。
