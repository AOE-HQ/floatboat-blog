...
### 提示词写得很详细，AI 给我的东西为什么还是很泛？

详细提示词有帮助，但它只能捕捉你能明确说出口的部分。你靠经验练出来的判断力——你如何权衡取舍、在你眼里"好"到底长什么样——这些很难靠指令传递。要让这道鸿沟收窄，通常得让 AI 接触足够多你真实的工作，而不只是你对工作的描述。

### 值不值得为 AI 工具自制提示词和上下文文档？

值得，但有一个提醒：**这笔时间投入是真实的，而且是持续的。**定制提示词和上下文文档，适合你频繁运行的工作流。一次性任务通常不值得花搭建成本。我会优先投资你重复最多的两三条工作流。

### 怎么分辨 AI 工具是真在学我的工作流，还是只是存笔记？

最清晰的信号是：在你没有写更长提示词的情况下，产出质量有没有随时间提升？如果你发现自己反复重新解释同样的偏好，那说明工具在"存信息"，却没有真正"从中学习"。学习意味着 AI 开始**预判**你想要什么——而不只是记住你告诉过它什么。

### AI 工作区和独立 AI 助手的主要取舍是什么？

搭建时间和可移植性。一个会学你模式的 AI 工作区需要前期投入——而且这笔投入某种程度上被锁死在特定工具上。一旦换工具，就得重来。独立助手可移植性更强，但永远不会积累上下文。该怎么选，取决于 AI 在你日常工作里的核心程度。

### 我试过 ChatGPT 的记忆功能，那不是一回事吗？

部分算。**ChatGPT 的记忆**会把你告诉它的事实跨 session 存下来，这有帮助。但它是平台专属的，不能迁移到其它工具——更重要的是，它只学你**明确告诉它**的东西。我这里说的是一个通过观察你**怎么**工作来学习的系统，而不只是听你**描述**怎么工作。这是完全不同的一根标尺。
