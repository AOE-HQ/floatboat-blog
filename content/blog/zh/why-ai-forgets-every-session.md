...
这种架构选择有真实的取舍。无状态系统更容易扩展、行为更可预测。但代价每一轮都完全落在你——用户——身上。你并没有随着时间得到更聪明的 AI，你只是变得更擅长重新解释自己。而这种「擅长」是按天计费的——[重置税累到一整周的账单](/zh/blog/why-ai-forgets-between-sessions)大约是每天一个多小时，全部花在把 AI 拉回它昨天本该在的位置，真正的活还没开始。
