...
截至 2026 年 4 月底没有官方日期。OpenAI 于 3 月 24 日完成预训练。Altman 说"还要几周"。最佳猜测：2026 年 Q2 末或 Q3。看 [OpenAI 官方公告](<https://openai.com/index/introducing-gpt-5/>)，别看 Twitter。

### GPT-6 会是比 GPT-4→5 更大的跃迁吗？

我不知道，写这个话题的任何人也都不知道。GPT-4→5 隔了 29 个月，落地后对大多数工作流是一次"有意义但不算剧烈"的升级。[维基百科的 GPT-5 条目](<https://en.wikipedia.org/wiki/GPT-5>)很好地记录了这种毁誉参半。GPT-6 来得更快（Altman 说间隔更短），这可能意味着每次发布的增量更小；也可能恰恰相反。走着瞧。

### 单人创业者该等 GPT-6 发布了再动手搭东西吗？

不用。让 GPT-6 有用的那些功课——文档化的工作流、个人上下文、风格参考——和你让当前模型更有用的是同一批功课。它会复利。

### 那个 200 万上下文窗口的传闻呢？

未经证实。在 OpenAI 发布模型卡之前，当同人文看就好。
