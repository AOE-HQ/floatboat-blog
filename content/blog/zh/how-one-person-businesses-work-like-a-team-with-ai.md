...
不一定。重点不在工具，而在角色定义本身。你可以先在现在用的工具里试「职位描述」这套做法：把上下文、标准和格式偏好写进系统提示词，看输出变不变。变了，就说明这个思路成立，然后再决定要不要给它换个更好的环境。

### 写一个角色定义实际要多久？

第一次大概 20–30 分钟。之后就只是小修小补——这里 5 分钟那里 5 分钟。头两周会感觉像在投入，到第三周基本就是自动运转了。

### 如果我自己还不太会做这个任务呢？

那角色就不会成立——而这不算缺陷，反而是有用的信息。AI 擅长执行清晰，却不能凭空制造清晰。你说不出「好」长什么样，输出就会听起来自信却答非所问。先自己上手做几次这个任务，再交给 AI。
