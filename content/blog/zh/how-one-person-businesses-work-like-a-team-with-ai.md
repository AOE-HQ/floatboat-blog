...
请求是一次性的交易，角色是持续的存在。发请求时你只说「帮我写段产品描述」，下次又从头再来；给角色时你定义它是谁、了解你什么、好输出长什么样——「你是我的产品沟通官，知道我们的语气和定位」。这样它能稳定维持同一套标准，不必每个会话都重新解释上下文。改变的正是这种连续性。

### 做到这套做法，需要换工具吗？

不一定。重点不在工具，而在角色定义本身。先从你正在用的工具开始：把上下文、标准和格式偏好写进系统提示词，拿真实任务测一测。输出变稳定了，说明思路成立；之后你再决定要不要换一个更结构化的 AI 工作区。

### 写一份角色定义要多久？

第一个角色大概 20–30 分钟；之后就是这里几分钟、那里几分钟的小修小补。从空白文档开始写「职位描述」——职责、它需要了解你的哪些情况、用什么格式交付。头两周会感觉像在投入，到第三周基本就自动运转了。

### 一人公司最需要哪些 AI 角色，先配哪个？

最常见的三个：研究分析师——跟住领域动态、从噪声里提炼信号；内容生产——懂你的语气、格式和受众，把原始想法变成成品；运营协调员——处理外联草稿、进度更新这类重复工作流。别一次全建，先挑目前最烧你时间的那一个。

### 如果我自己还没完全会做这个任务呢？

那角色就不会成立——这不算缺陷，反而是有用的信号。AI 擅长执行清晰，却不能凭空制造清晰：你说不出「好」长什么样，输出就会听起来自信却答非所问。先自己上手做几遍，再交给 AI。角色框架只有在你定义得出这份工作时才成立。

### 这套做法在哪些情况下失灵？什么时候还得找人？

角色会在你自身清晰度的边界上失灵，也搞不定依赖真实关系背景的工作——比如你知道某位客户正经历一个难熬的季度。AI 擅长可重复、上下文厚重、输出明确的任务，但在判断人心、创意方向、客户信任、或真实不确定性下的战略思考上明显逊色，这些仍需要人。而且搭好角色本身也要前期思考，它是投资，不是捷径。
