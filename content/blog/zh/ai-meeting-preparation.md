...
## 延伸阅读- [AI 会议后续跟进自动化——流水线的会后一侧：AI 如何把会议结果转化为任务、草稿与下一场会的准备材料。](/zh/blog/ai-follow-up-automation)
- [什么是 Agentic Calendar？——日历驱动 AI 系统的基础定义，它执行整个会议生命周期。](/zh/blog/what-is-agentic-calendar)
- [日历驱动 AI vs 基于聊天的 AI——为什么由日历触发的准备，与让一个聊天 AI 去做准备，在架构上根本不同。](/zh/blog/calendar-driven-ai-vs-chat-ai)