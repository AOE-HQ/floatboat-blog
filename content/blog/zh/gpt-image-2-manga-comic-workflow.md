...
长宽比支持最高 1:3 的竖幅，适配 webtoon 分格。风格上，韩式 webtoon 的效果相当不错。我还没用它完整推完一整话。

### 能用于商业作品吗？

去查当前 OpenAI 的使用政策——产出通常可商用，但对"生成可辨识 IP"的限制很严格。这不是法律建议，只是建议你直接查政策原文。

### 它会取代真正的画师吗？

不会。它压缩的是漫画制作里一直属于苦力活的部分。品味、故事、分格节奏——那仍然是你。

### 现在完成一页比以前快多少？

以前：一页精修黑白稿要 6–8 小时。现在：约 2 小时，含手动修手。随着我 prompt 越来越熟练，这个数字还会继续降。
