...
也许，但大概不是 OpenAI 描述的那种方式。这个提案谈的是政府补贴的雇主试点，那个框架并不直接适用于单人创业者。

真正适用的是那个底层前提：**AI 的生产率增益能否转化为"同样产出、更少工时"**——这在个体层面是真实且可检验的。我做过不算严格的检验。诚实的答案是：它在很大程度上取决于你做什么类型的工作、以及你的工作流搭得有多好。研究密集、写作密集、分析密集的工作——是的，AI 帮助显著。面向客户、关系驱动、创意性的工作——帮助没那么大，而且效率增益更难衡量。

### AI 真的能减少工时吗？

[CNBC 对四天工作周研究的报道](<https://www.cnbc.com/2025/07/24/the-most-surprising-benefits-of-a-4-day-workweek-from-researcher-whos-studied-thousands-of-cases.html>)发现，员工自我报告的生产率显著提升；而且关键的是，人们并不只是四天里更拼命——变化来自公司层面"工作如何发生"的重新组织。

对用 AI 的单人创始人：短答案是能，但有个前提。AI 减少的是具体任务上的时间。至于这能否转化为总工时减少，取决于你是自觉地把那些时间收回来，还是只是用更多工作把它们填满。大多数人会填满。我一开始也是。

### 是什么工具促成了这种转变？

这是我最近一直在投入注意力的地方。最有帮助的往往不是最花哨的工具——而是那些能嵌进现有工作流、又不需要你把一切推倒重来的工具。

在工作流级 AI 上，我一直在探索 [Floatboat AI](</>)，它和标准 AI 聊天工具走的是不同路线。它的 Combo Skills 功能把 AI 能力——读文件、分析内容、生成结构化输出——串成可复用工作流，而不是一次性 prompt。实践上的区别：一旦你建好一条工作流，就不必每次从头重新 prompt。真正的时间节省是在这里复利累积的。

在研究写作方面，最有帮助的是那些降低任务间切换成本（读、整理、起草）的工具，而不只是加速某一步。

有一点我要说清楚：没有任何工具能免掉你对 AI 产出的评估。那一层判断仍然是你的事，而且大概永远都是。
