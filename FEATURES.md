...
Example — `xEmbed`: when `true`, a standalone X/Twitter status URL line in Markdown renders as an official widgets.js embed; on failure, a fallback “View post on X” link appears. Default `false`. See [AGENTS.md](https://github.com/kostja94/openblog/blob/main/AGENTS.md#x-twitter-embeds).
