...
import type { FaqItem } from "../content/article-sections";
import type { FinalCta } from "../content/final-cta";
import type { TldrContent } from "../content/tldr";
...
export const postFrontmatterBaseSchema = z.object({
  ...
  /** Optional TL;DR in frontmatter (legacy flat string). Prefer ## TL;DR in body. */
...
export interface PostMeta {
  ...
  coverImage?: string;
  /** TL;DR block parsed from ## TL;DR section in body */
  tldr?: TldrContent;
  /** FAQ items from faq-data.json sidecar */
  faq?: FaqItem[];
  /** Final CTA from final-cta-data.json sidecar */
  finalCta?: FinalCta;
}
